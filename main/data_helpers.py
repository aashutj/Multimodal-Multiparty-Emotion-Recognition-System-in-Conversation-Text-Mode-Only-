...
class Dataloader:
    ...
    def load_audio_data(self, ):
        ...
        AUDIO_PATH = "/content/drive/My Drive/MELD-master/data/pickles/audio_embeddings_feature_selection_{}.pkl".format(self.MODE.lower())
    ...
    def load_bimodal_data(self,):
        ...
        TEXT_UNIMODAL = "/content/drive/My Drive/MELD-master/data/pickles/text_{}.pkl".format(self.MODE.lower())
        AUDIO_UNIMODAL = "/content/drive/My Drive/MELD-master/data/pickles/audio_{}.pkl".format(self.MODE.lower())
